...
#group node[:jenkins][:server][:user] do
#end
...
# make a initial call in order to prepare cli (usually this is called on first call of a job resource, but it is better to have it prepared)
